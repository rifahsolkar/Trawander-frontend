...
export default function Flight(props) {
    ...
    let data =[
        { token: localStorage.getItem("token"), from, to, price: '20000'*totalcustomer,date,type:"Flight",typename:'Go First',totalcustomer},
        { token: localStorage.getItem("token"), from, to, price: '4000'*totalcustomer,date,type:"Flight",typename:'Spicejet',totalcustomer},
        { token: localStorage.getItem("token"), from, to, price: '7000'*totalcustomer,date,type:"Flight",typename:'IndiGo',totalcustomer},
        { token: localStorage.getItem("token"), from, to, price: '6000'*totalcustomer,date,type:"Flight",typename:'Air India',totalcustomer},
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" className="btn btn-primary" onClick={() => handleSubmit()}>Book now</button>
            ...
            <h2 className="text-center">Flights founds for you</h2>
            {data ? data.map((d) => {
                return (
                    <>
                        <div className="card">
