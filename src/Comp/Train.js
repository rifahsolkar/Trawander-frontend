...
export default function Train(props) {
    ...
    let data =[
        { token: localStorage.getItem("token"), from, to, price: '2000'*totalcustomer,date,type:"Train",typename:'Madgaon Express',totalcustomer},
        { token: localStorage.getItem("token"), from, to, price: '400'*totalcustomer,date,type:"Train",typename:'Rajdhani Express',totalcustomer},
        { token: localStorage.getItem("token"), from, to, price: '700'*totalcustomer,date,type:"Train",typename:'Kokankanya Express',totalcustomer},
        { token: localStorage.getItem("token"), from, to, price: '600'*totalcustomer,date,type:"Train",typename:'Tutari Express',totalcustomer},
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" className="btn btn-primary" onClick={() => handleSubmit()}>Book now</button>
            ...
            <h2 className="text-center">Trains founds for you</h2>
            {data ? data.map((d) => {
                return (
                    <>
                        <div className="card">
